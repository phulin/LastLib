...
/-- A finite effective Cartier boundary with an integer coefficient on each
component. -/
...
def chapter04TransformedReducedBoundary
    {X : Scheme.{u}} {I : X.IdealSheafData}
    {n : ℕ} {boundary : Chapter04Boundary X n} {x : X}
...
theorem chapter04_reduced_boundary_transform_formula
  ...
  simp [chapter04BoundaryIdeal, chapter04TransformedReducedBoundary]
...
theorem chapter04_transverse_pair_meets_each_strict_transform_once
    ...
    chapter04IntersectionNumber P.C_data.transform.divisor
        P.exceptional.divisor = 1 ∧
      chapter04IntersectionNumber P.D_data.transform.divisor
...
theorem chapter04_single_component_exceptional_multiplicity
  ...
  simp [chapter04SingleComponentExceptionalMultiplicity]
