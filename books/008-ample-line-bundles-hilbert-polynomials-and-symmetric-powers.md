...
which the divisor functor of Section 11.4 is treated as a sheaf.
...
descend there, using the descent statements proved in Section 10.5 and nothing else.
...
relative effective Cartier divisors of a fixed degree is a sheaf for these covers. A general
