...
the point at infinity is denoted $\infty$. Book 150 proves that every class
...
positive definiteness come from Book 43; an application must still prove the
...
pairs of Book 150. Curve enumeration and Jacobian order may be checked
...
height gap of Book 43 proves discreteness; an effective certificate must
...
In both curves treated later the rank is zero. Book 151 proves the entire
...
Book 151 proves, by true sextic two-descent and independent good-reduction
torsion bounds, that
...
Book 151 proves the exact relations and the complete group
