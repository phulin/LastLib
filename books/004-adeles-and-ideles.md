...
The first temptation is to take the product of all completions. That product is too large. An arbitrary family may have denominators at infinitely many primes, whereas a single algebraic number has only finitely many prime divisors in its denominator. The opposite temptation, the additive direct sum, is too small: although it contains the all-zero identity family, it excludes the all-ones family and therefore is not a unital subring of the product. The restricted product occupies the precise middle ground. It permits arbitrary local behavior at finitely many places and requires integrality at the rest.
