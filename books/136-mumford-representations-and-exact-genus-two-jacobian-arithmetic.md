...
The intrinsic geometric input is the theorem package proved in Book 135: a smooth proper
...
The finite-field input is the Weil theorem for smooth proper curves proved in Book 37 and imported
geometrically in Book 135: Frobenius on $H^1$ has four eigenvalues of absolute value $\sqrt q$ in
