...
The preceding theory enters in six precise forms. Book 42 supplies marked
...
Book 63 supplies strict equivalence, adjoint tangent spaces, and the complete
matrix obstruction across a small extension. Book 66 supplies the
fiber-product criteria for hulls and universal rings. In the
unramified low-weight range, Book 54 supplies the exact contravariant
...
of Cartier duality with generic fibers from Book 42, and apply the first
...
Book 42; generic compatibility of the internal coefficient-linear dual was
...
coefficient-ring and Schlessinger theory of Books 63 and 66, convert formal
...
power-series criterion of Book 66 therefore gives (17.1).
