...
the top lattice is generated by $da\wedge d\alpha_2\wedge\cdots\wedge d\alpha_r$, and (8.3a)
...
$\operatorname{Tr}_{L'/L}(\Delta^{-1}D')=D$, which proves (8.3b) and the multiplier assertion.
