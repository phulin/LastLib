...
In the inseparable case, multiplication by $z\in L'$ preserves the left side of (8.3b) if and
...
**Proof.** Localize at one prime of $D'$, so the two rings are DVRs; we do **not** assume that
$D'$ is monogenic over $D$. Choose a finite presentation

$$
P=D[t_1,\ldots,t_m]\twoheadrightarrow D'
$$

and a finite free $P$-resolution of the finite $P$-module $D'$. Apply continuous differentials
to the Koszul complexes of finite polynomial subpresentations and take the alternating
coefficient (residue) map in top degree. Passing to the directed limit gives a $D$-linear map

$$
\tau_{D'/D}:Q^r(D'/k_0)\longrightarrow Q^r(D/k_0).          \tag{8.3b'}
$$

Changing the presentation adds a contractible Koszul factor, whose two alternating coefficient
maps cancel. Tensor products of resolutions show transitivity in a tower. Hence (8.3b') is
intrinsic and may be checked after tensoring with $L$. For a separable field step it becomes
...
Thus it is the previously defined field map. Because the construction was made over $D$, not
after inverting its uniformizer, it proves (8.3b) without a primitive integral generator.

Let $M'$ be the image of the torsion-free quotient of $Q^r(D'/k_0)$ in its generic fiber. It is a
nonzero fractional ideal of the DVR $D'$. Therefore

$$
\{z\in L':zM'\subseteq M'\}=D'.                            \tag{8.3b''}
$$

This gives the multiplier assertion in the inseparable case. In the separable case the assumed
torsion-freeness identifies $M'$ with the complementary-module lattice; trace duality gives the
same equality. Intersecting over the finitely many primes of the semilocal Dedekind ring proves
all the assertions. $\square$
...
$r\notin\mathfrak p$ so that $e_i=re'_i\in B$. Choose the top form in (8.3c) to generate the
...
that conclusion and gives (8.3e). $\square$
