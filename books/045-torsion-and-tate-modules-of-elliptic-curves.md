...
Let $K$ be complete for a normalized discrete valuation, with ring $R$, residue field $k$, and residue characteristic exponent $p$. Suppose $E/K$ has good reduction. Book 43 then supplies a smooth proper group curve
