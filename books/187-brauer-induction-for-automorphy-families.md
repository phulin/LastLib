...
First, Chapters 2--3 import from Book 176 and fix the application notation for integral Brauer
...
Book 176, Chapter 3 is the source for finite-index induction, the tensor identity, Frobenius
...
Negative multiplicities are allowed until Book 188 verifies positivity. All profinite
...
Book 176, Sections 3.1 and 5.1 supply finite-index preservation of semisimplicity for induction
...
Book 176's Mackey theorem gives
...
For $d=\dim W$, Book 176's determinant-transfer formula is
...
Book 176, Chapter 2 proves monomiality, the elementary restriction/projector criterion, and
...
Book 176 proves that every irreducible character of an elementary group is induced from a
...
The $p$-element projector and Brauer restriction criterion of Book 176 show that a rational
...
Apply Book 176's integral Brauer induction theorem to $\Gamma$. Choose once and for all
...
is precisely the positivity problem verified for the SP packet array in Book 188.

## 4. Prime-cyclic towers inside elementary groups

Book 176, Chapters 4--5 provide the general subgroup-chain theorem and the cyclic
...
Book 176 proves this and uses it to refine subgroup inclusions. Since elementary groups are
nilpotent, the result applies to every $H$ and every Mackey intersection $D$ below.

### 4.2 Subnormal prime-cyclic refinement

For $D\leq H$ elementary, choose the Book 176 refinement
...
Book 176, Section 5.4 says that two irreducible extensions of the same irreducible
...
$\rho|_{G_M}$. The cyclic extension torsor of Book 176, Section 5.4, recorded here in (4.6),
...
**Proof.** Book 176's Clifford restriction in Section 5.1, applied to the normal core, together
...
torsor of Book 176, Proposition 5.1 shows that they can differ by a character of
...
representations are semisimple, and the averaging argument of Book 176, Section 3.1 promotes
...
Book 176 supplies integral Brauer induction, the tensor identity, determinant transfer,
...
$$
\boxed{187\mid95,\ 96,\ 97,\ 171,\ 176,\ 186.} \tag{11.3}
$$

| Source | Input used here | Strengthening not made |
|---|---|---|
| Book 95 | finite-order Hecke avatars of the Brauer characters, with reciprocity, norm pullback, and conjugation | no higher-rank automorphic induction across $F_H/\mathbf Q$ |
| Books 96--97 | selected prime-cyclic descent and base change, antecedent-complete saturated fibers, local-parameter restriction, and tower independence in the admissible range | no transfer along an inadmissible tower and no nonsolvable descent |
| Book 171 | the controlled Galois fixed-field diagram, preservation by complete splitting, and the density input used for good Frobenius comparison | no assertion that the field-theoretic towers satisfy automorphic selectors |
| Book 176 | monomiality, the elementary projector and integral Brauer relation, induction/tensor/Mackey/determinant formulas, prime-cyclic refinement, and the cyclic Clifford torsor | no packet construction, overlap identity, Gram positivity, or coefficient family is imported |
| Book 186 | the exact conditional controlled SP datum: $\rho$, $M$, the distinguished top realization, and the SP record | the missing controlled residual automorphic seed is not supplied by this book |
...
the full virtual SP record. General character and induction theory is cited from Book 176 rather
