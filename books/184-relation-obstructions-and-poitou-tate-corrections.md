...
- [7. The balanced hardly-ramified bound](#7-the-balanced-hardly-ramified-bound)
  ...
  - [7.3 The exact interface to Book 185](#73-the-exact-interface-to-book-185)
...
Book 183 constructs the supported mapping fiber
...
\(\operatorname{loc}_v(y)\in L_v^\perp\). Book 183's supported
...
is zero. Book 183's exact Greenberg--Wiles identity yields
...
### 7.3 The exact interface to Book 185
...
183. No general number-field or idelic detour is needed for the stated
deformation problem.
...
for Book 185: actual relation directions inject into the correctly supported
