...
adjective _simple_ refers to a carefully chosen local test function, not to an absence of
...
The term _elliptic_ is global here: it means that the connected centralizer is anisotropic
...
One must distinguish this connected centralizer from the stabilizer of the _projective_ rational
element. Set
