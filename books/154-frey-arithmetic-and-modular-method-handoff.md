...
- If $5\mid n$, the solution contradicts the exponent-$5$ theorem of Book 192.
...
It remains to remove exponents $3,4,5$. The exponent-$5$ case is imported from Book 192; the other two are included so that the elementary reduction is complete.
...
$$
  ...
  \tag{6.7}
$$
The lower bound $p\ge7$ is essential to this invocation. Exponent $5$ has already been discharged by Book 192 and never enters this argument.
...
- no exponent-$5$ branch, by Book 192;
...
|---|---|
| 155 and 156 | coefficient primes are in the range at least $7$, with finite-flat coefficient-prime and special dyadic conditions |
| 182 | the residual matrices, intrinsic monodromy line, fixed sign, and global hardly-ramified deformation datum are exactly those of Section 7 |
| 185 | the balanced minimal-lift input begins with the same absolutely irreducible signed SP residual datum |
| 180 | only the conditional three-adic package-to-trace contradiction recorded in Section 8.2 is used for orientation |
