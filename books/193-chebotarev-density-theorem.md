...
the content of Books 2 and 3. Book 4 supplies Minkowski lattices, the unit lattice, ideles, ray
classes, and finite-order Hecke characters. Books 5 and 6 supply local and global reciprocity,
...
Finite étale covers and fundamental groups from Book 19 explain why finite quotients of an
absolute Galois group correspond to finite Galois extensions. Books 20 and 25 explain the
geometric-Frobenius convention used in cohomology and trace formulas. Book 29 supplies the
...
- Books 2 and 3 provide decomposition groups, inertia, the local Frobenius exact sequence,
...
- Books 5 and 6 provide arithmetic local and global reciprocity, cyclic character fields, and
...
- Book 19 supplies the finite-cover interpretation of finite Galois quotients; Books 20 and 25
  fix the geometric convention in cohomological applications; Book 29 supplies the profinite
