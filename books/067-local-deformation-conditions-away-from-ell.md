...
| Unramified, fixed $\delta$   | above and $\delta\vert_I=1$                                        | framed quotient                                | kernel of trace on $H^1_{\mathrm{ur}}$  | smooth of dimension $d^2-1$                                                                                              |
...
| Fixed finite type $\theta$   | $\#H$ prime to $\ell$ and compatible integral $\theta$             | framed quotient; unframed with descent         | $H^1_{\mathrm{ur}}(K,M)$                | framed smooth of dimension $d^2$; fixed determinant requires surjective centralizer trace                                |
