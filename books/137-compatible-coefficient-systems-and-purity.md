...
|---|---|---|---|
| Weil-number calculus and good-place purity of curve $H^1$ | Book 26, *Weights and Weil Bounds for Curves and Abelian Varieties* | smooth proper curve over a finite field; geometric Frobenius; correspondence summand | it supplies no bad-place return-map weights |
