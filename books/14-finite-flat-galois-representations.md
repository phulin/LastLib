...
In the language of the prerequisites, Book 9 supplies the torsion representation, invariant lines, pairings, and good-reduction consequences, while Book 12 supplies integral torsion kernels, schematic closure, and represented quotients. The present book does not rebuild them; it identifies their common output as a finite-flat Galois representation and explains which representation-theoretic operations preserve that output.
