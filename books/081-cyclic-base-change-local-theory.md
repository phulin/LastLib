...
This matches the normalized induction and Whittaker conventions of Book 73, the selected
parameter dictionary of Book 76, and the local inner-form conventions of Book 80. Book 5 states local class field theory with
...
We use the selected rank-two local parameter correspondence proved in Book 76,
...
smooth theory from Books 73--74 supplies the representation-theoretic families;
Book 76 constructs this correspondence and proves its invariant and local-factor
...
representation it agrees with the selected newvector conductor of Book 76. For a
...
**Dependence on the Frobenius convention.** This is the selected theorem of Book 76
...
computations agree with the newvector normalization of Book 76 and the zeta-integral normalizations of Books 73--74.
...
the substantive results recalled from Book 76. Nothing here asserts the corresponding
...
not itself one of the admissible tame labels constructed in Book 76. Section 8.4
...
which Book 80 proves local Jacquet--Langlands in the selected range: special twists
...
dictionary makes them isomorphic. The conclusion is exactly as broad as Book 80: it
...
This package prescribes the local components required in Book 108. It does not assert
