...
**Localized odd-primary abelian congruence condition
$({\rm AC}^{\rm loc}_\ell)_{\mathscr R}$.** For every $R\in\mathscr R$, with residue field $k_R$, one
has
