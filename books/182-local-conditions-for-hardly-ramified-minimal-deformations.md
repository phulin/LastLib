...
- [5. Exact interfaces to Books 183--185](#5-exact-interfaces-to-books-183--185)
...
Book 154, Sections 3.1 and 4.3, take $a$ to be the even leg and give
...
basis, as recorded in Book 154, Section 5.2.  A residual diagonal change of
...
characters are closed matrix-and-line equations.  Book 66, Theorem 7.1,
...
quotient its $B$-action.  This is Book 67, Theorem 2.3.  It avoids raw
...
Book 67, Theorem 14.3, gives the covariant torsion
...
Self-duality therefore gives $r=2-r$, so $r=1$.  This is Book 67,
...
Combining Book 67, Theorems 9.1--9.2, 16.1, and 17.1, with
...
Books 183 and 184 introduce supported cohomology precisely to retain those
two defects.

### 4.5 Coefficient extension and compatible finite levels

Let $\mathcal O'/\mathcal O$ be a finite extension.  The dyadic equations,
the line, and the sign commute with scalar extension.  At $\ell$, Book 67,
...
## 5. Exact interfaces to Books 183--185

### 5.1 Input to supported cohomology

For the Frey-SP specialization, Book 183 uses the following data and no
...
and supported-duality calculation.  Book 183 defines the dual local
...
For its Frey-SP specialization, Book 184 needs nonlinear local conditions,
...
The possible nonscalar local centralizer at $\ell$ causes no gap.  Book 184
...
- the tangent and obstruction inputs already passed through Books 183--184.

Book 185 treats its additional restricted reduced-finiteness hypothesis
...
- Book 185's restricted reduced-finiteness hypothesis (RF);
...
this book to Books 183--185 is exactly the Frey-special specialization
...
8. The exact downstream interface is the ledger of Sections 5.1--5.3.  In
   particular, the local theorem supplies neither Book 185's hypothesis
...
Section 3.4; these specialize Book 67, Theorems 2.3, 14.3, 16.1, and 17.1,
...
| Book 50 | Tate-curve inertia, Frobenius sign, and conductor of a rank-one monodromy block | Sections 1.3 and 2.5 |
| Books 64--65 | strict equivalence, tangent and obstruction theory, scalar-centralizer representability, and closed global quotients | Sections 1.4, 2.4, 3.4, and 4.2 |
| Book 66, Theorem 7.1 | closed and liftable nonzero-monodromy minimal condition | Section 2.4 |
| Book 67, Theorems 2.3, 9.1--9.2, 14.3, 16.1, and 17.1 | coefficient change, finite-flat classification, representability, liftability, tangent dimensions, and smooth rings | Chapter 3 |
| Book 154, Sections 3.1, 4.3, and 5.2 | normalized Frey equation, dyadic discriminant and sign, and nonzero residual monodromy | Section 1.3 |
...
Book 67 discharges the lower-level integral inputs on closure, Raynaud
rigidity, and Fontaine--Laffaille theory; this book invokes its packaged
theorems rather than silently strengthening them.  No result from Books 183,
184, or 185 is used to prove Theorem 6.1.  Those books consume the outputs
listed in Chapter 5.

There is therefore no hidden conditional theorem in the local package.
The later global conclusion remains external: Book 185 states the additional
...
Book 183 performs the supported cohomology calculation, Book 184 converts
relations into supported obstructions, and Book 185 adds its separately
