...
$K_0$. Both roots lie in the henselian ring $B$ and lift the same simple residue root, so Hensel
uniqueness makes them equal. Consequently the given embedded field $E$ is literally contained
