...
### 1.1 What Book 189 actually supplies
...
Assume the controlled signed-special, or **SP**, top datum used by Books 187--189, and apply
the conditional base-field assembly theorem of Book 189. It gives a number field $E$ and,
...
At two, in arithmetic-Frobenius normalization, Book 189 supplies an algebraic pair
...
The last omission is equally important. Book 189 proves unramifiedness outside a finite set
...
It is enough to verify $(\mathrm U)$ at the finite auxiliary set left by Book 189, since
...
This explains why $(\mathrm C_3)$ is the first exact blocker after Book 189. Once it is known,
...
The geometric certificate is stronger than needed: Book 138 then constructs the first local
...
Book 189 provides, at each coefficient place, an actual characteristic-zero cancellation
...
enough. Book 189 supplies the first term of (2.5), not the second.
...
If the direct geometric certificate (2.2) is available, Book 138 supplies another route to
...
The proof is a special case of the committed closure-tower theorem of Book 138. Its decisive
...
This is the rigidity step emphasized in Book 138: levelwise closure gives flatness, but it is
...
The conclusions at two are now all derived from Book 189's rational SP pair and the chosen
global lattice:
...
Let $S$ be the finite exceptional set in Book 189's base-field assembly theorem. Outside $S$
...
The roots of these polynomials are pure of weight one. At a prime in $S$, Book 189 proves a
...
and more reusable certificate proves that $q$ lies in Book 189's local comparison range and
...
Second, one may use Book 189's algebraic local complement. If
...
189 is cofinite, so such a prime exists even before a particular auxiliary prime has been
...
### 9.2 What Book 180 may use

The branch-independent input to the three-adic endgame is now exactly present. Book 180 may
...
base-field compatible-system theorem of Book 189 and the coefficient-prime certificate
...
5. Rationally, the monodromy at two is nonzero of rank one, its line and sign are those of
   Book 189, and its Artin conductor exponent is one.
...
of the conditional Frey--SP three-adic reducibility theorem in Book 180. A prime in Book
189's cofinite certified good set supplies the separate pure Frobenius polynomial used after
reducibility.
...
Book 138's commensurability theorem proves that the finite-flat existence property survives
...
| Book 48 | marked finite-flat models, schematic closure, represented quotients, coefficient actions, and finite-etale models | Proposition 4.2 and the local-to-global model calculus | no extension is called finite flat from its endpoints alone |
| Book 59 | integral Fontaine--Laffaille realization, full faithfulness over $\mathbf Z_3$, admissible coefficient quotients, and exact compatible systems | Chapters 3 and 5 | rational Hodge labels do not select a lattice |
| Book 138 | saturated geometric intersections, exact closure towers, commensurability transfer, coefficient change, and the fixed-three handoff | the geometric route and the proof architecture of Chapters 3--5 | no canonical geometric carrier or integral projector is claimed |
| Book 189 | the actual coefficient-descended member, determinant, purity at its good primes, and the full signed SP pair at two | the rational starting object and dyadic local data | no coefficient-prime comparison, clean support, lattice, or tower is imported |

Accordingly the proposed direct dependency row is

$$
\boxed{190\mid 3,\ 48,\ 59,\ 138,\ 189.}
\tag{11.1}
$$

Books 136--137 are transitive sources for the packet comparison records used inside Books
187--189 and explain the coefficient-prime boundary. Books 154 and 182 establish the Frey
provenance and deformation-theoretic meaning of the signed SP line. Books 187--188 construct
the SP packet array and prove rational effectivity. None is a separate direct proof input after
the packaged theorem of Book 189 is assumed. Books 180--181 are downstream consumers, not
prerequisites of Theorems 10.1--10.2.

### 11.2 Exact blocker audit

Even conditional on Book 189's controlled SP top datum, its theorem does not prove
...
Once this theorem is supplied, no lattice hypothesis remains: Proposition 3.1, Book 59, and
Book 138 construct the lattice and all of its levels.
...
> Book 189's algebraic local complement and proving it unramified. Record a common Frobenius
...
The conditional controlled SP top datum upstream of Book 189 is inherited by this statement.
...
**Attack: Books 187--189 have monodromy zero or a tame-quadratic type.** They do not. Their
...
**Attack: Book 181 can be used to construct the tower.** The direction is opposite. This book
constructs the tower using Books 48, 59, and 138; Books 180--181 consume it.
...
Book 189 already supplies the correct signed-special member at two: its monodromy is nonzero of
...
is precisely the input to Book 180's conditional Frey--SP reducibility theorem.

### 12.2 Readiness verdict

The integral construction is complete as a conditional theorem. The current dependency spine
does not, however, prove its two rational source certificates. In particular, Book 189 itself
