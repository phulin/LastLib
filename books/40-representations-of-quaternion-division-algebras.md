...
We write $\operatorname{Trd}$ and $\operatorname{Nrd}$ for reduced trace and reduced norm. Book 33 established their intrinsic meaning. Here the norm is more than a quadratic form: it supplies the valuation and eventually the entire abelianization of $D^\times$.
