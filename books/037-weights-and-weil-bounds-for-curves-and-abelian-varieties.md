...
Rationality has to be established before any Archimedean argument. Apply the constructible-coefficient trace formula of Book 23 to $j_*\mathcal F$ on the proper curve $C$:
...
Finally Book 23 applies to every deck correspondence and every product:
