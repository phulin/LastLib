...
15. [The fixed-$3$ member and the contradiction](#15-the-fixed-3-member-and-the-contradiction)
    ...
    - [The complete Book 180 ledger](#152-the-complete-book-180-ledger)
...
explicit mixed-torsion calculations of Book 148.
...
The semistable full-two criterion (13.6) in Book 148 proves the exact
FLT-facing result:
...
Book 148 derives from Tate normal form the necessary curve
...
The complete Jacobian descent and Mordell--Weil sieve of Book 148 gives
...
representability theorem of Book 68, applied to the represented framed local
...
Book 148 and Section 9 prove absolute irreducibility, including $p=5$ and
...
finite-flat deformation condition with determinant $\chi_p$.  Book 67 proves
...
weights are $\{0,1\}$.  The low-weight classification used in Book 67
...
The two-prime construction of Book 170 is used with more data than an
...
good-reduction target.  The closure and quotient results of Books 46, 48,
and 67 retain the coefficient action.  The finite-flat local deformation
...
155 applies over $F$ without change.  We record the kernel-killing step because
...
Books 155, 156, and 170 explain this infrastructure but do not prove every one
of these Frey-special scalar, vexing, and coefficient-prime cases.  Books
73--75 prove the patching algebra once the arithmetic modules, maps,
...
A single $p$-adic lift still cannot be fed into Book 180.  It must be spread
...
Book 135 attaches to $\Pi_M$ a compatible system
...
The available books do not prove Theorem 13.1.  In particular, Book 155 starts
with a residual automorphic maximal ideal, Book 156 leaves the nonminimal
arithmetic infrastructure as hypotheses, Book 170 leaves its
lifting-admissible realization and nonminimal packages as hypotheses, and
Book 176 makes effectivity conditional on a coherent cocycle or determinant
...
what Book 180 needs: every stable lattice in the rational summand works.
...
$\mathcal A[3^r]$.  The closure theorem of Book 46 makes them finite flat;
...
represented quotient.  Book 48's subquotient theorem makes the quotient
...
This proves the fourth hypothesis of Book 180, Theorem 18.6.  It is no longer
a separate bridge assumption.

## 15. The fixed-$3$ member and the contradiction

The last step uses the exact prime-$2$ theorem of Book 180.  It is important
...
not assert that the integral extension class is a unit.  Book 180 permits
both trivial residual inertia and tame cyclic inertia of order $3$.

### 15.2 The complete Book 180 ledger

The member $V_3$ and lattice $T_3$ satisfy the five hypotheses of Book 180,
...
Book 180, Theorem 18.4 first gives
...
to $3$, the geometric lattice theorem of Chapter 14, and Book 180's
...
Book 180 gives (15.3), contradicting purity.  Hence a proof of Theorem 13.1
...
- Books 46 and 48 prove schematic closure, represented quotients,
  ...
  supplied.
- Book 67 proves the unramified odd-prime rank-two finite-flat classification
  and explicit small-extension lifting used in Lemma 11.2.  Book 68 supplies
...
- Books 73--75 provide the algebra of Taylor--Wiles systems, patching,
...
- Book 94 supplies global Jacquet--Langlands in the stated range, and Book
  135 supplies Galois representations and geometric Jacobian realizations
  from weight-two automorphic forms.
- Books 155 and 156 state the minimal and nonminimal lifting mechanisms, but
  their arithmetic control and nonminimal packages are not unconditional
  in every Frey-special branch.
- Book 170 supplies the two-prime potential-modularity architecture, but its
...
- Books 175--177 supply compatible-system bookkeeping, Brauer identities,
...
- Book 148 proves the semistable full-two irreducibility theorem, including
  the explicit degrees $5$ and $7$.
- The repaired Book 180, Theorems 18.4 and 18.6, unconditionally supplies the
