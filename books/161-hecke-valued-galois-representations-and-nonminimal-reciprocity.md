...
| Book 135, *Galois Representations Attached to Weight-Two Automorphic Forms* | branchwise rank-two attachment, determinant, good polynomials, integral lattices and finite-flat quotients | noncharacter parallel weight two in the stated Shimura-curve range; integral conclusions only with the integral realization datum |
