...
- [7. The theorem and the downstream contract](#7-the-theorem-and-the-downstream-contract)
  ...
  - [7.2 Interface to Books 184 and 185](#72-interface-to-books-184-and-185)
...
are equal. The construction is the cohomological input used by Books 184 and
185. No presentation theorem, automorphy argument, finiteness theorem, or
...
Book 68 isolates the two adjacent defects in a constrained global lifting
...
group requires the affine local lift-torsor argument of Book 184 and is not
assumed here.
...
### 7.2 Interface to Books 184 and 185

Book 184 may use exactly the following outputs, with no additional
...
Book 184 supplies what is deliberately not proved here: it constructs the
...
Book 185 may then combine the relation injection from Book 184 with (6.10)
...
in the Book 184/185 hardly-ramified lift:
...
|---|---|---|
| Book 29, *Continuous Cohomology of Profinite Groups*, Chapters 2, 3, and 7 | continuous cochains, low-degree cocycles, cup products, and signs | finite discrete continuous \(k\)-modules |
...
```text
Books 29--33 --- cochains, Euler formulas, local/global duality ---+
Book 68 -------- deformation tangent and obstruction shape --------+--> Theorem 7.1
Book 182 ------- local conditions and the dimension ledger --------+         |
                                                                           v
                                                                 Books 184 and 185
```

Every incoming edge comes from a book numbered below 183. Books 184 and 185
...
dependencies are discharged inside Book 182, so this book uses Book 182 as
...
local, global, real, and coefficient-prime term on which Books 184 and 185
depend.
