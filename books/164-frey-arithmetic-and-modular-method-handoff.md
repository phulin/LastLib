...
The second branch is the Frey residual/deformation spine. Book 151 applies exactly in its natural range $p\ge 7$; it is not asked to prove anything at exponent $5$.
...
Book 163 proves this theorem by descent in $\mathbf Z[\zeta_5]$. Its proof, including the ramified prime above $5$, the unit calculation, and the class-number-one input, is independent of the Frey-curve argument here. No result from Book 151 is used for exponent $5$.
...
numerical divisibility of $\#E[2](\mathbf Q)$, is the input to Book 151.
...
Book 151 proves the following theorem in exactly the range needed here.
...
| 151  | semistable full-two residual irreducibility for every prime $p\ge7$                                                                      | Section 6.3          |
| 163  | the complete exponent-$5$ descent                                                                                                        | Sections 2.4--2.5    |

Book 162 supplies cyclotomic foundations to Book 163, but no theorem from it is invoked directly here. Likewise the prerequisites internal to Books 43--45 and 151 remain transitive dependencies, not extra direct imports.
