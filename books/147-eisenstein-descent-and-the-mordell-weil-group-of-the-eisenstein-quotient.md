...
Book 41's Mordell--Weil theorem already supplies the finite generation used
...
Book 132's exact integral Eisenstein calculation says that this normalized
...
- Book 40 supplies isogeny Kummer maps, finite-flat local images at good
  primes, finiteness of finite-level Selmer groups, and weak
  Mordell--Weil.
- Book 41 supplies canonical heights, Northcott finiteness, the
  Mordell--Weil theorem, and its applicability to every abelian quotient of
  a Jacobian.
- Book 132 fixes the prime-level Hecke algebra including $U_N$, the
...
- Book 133 supplies the order-$n_N$ cuspidal subgroup, its isomorphic
