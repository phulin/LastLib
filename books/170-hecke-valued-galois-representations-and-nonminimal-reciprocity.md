...
| Book 167, *The Chebotarev Density Theorem* | finite Galois Frobenius selection with positive Dirichlet density and closed-condition transport | finite Galois extension, removal of a finite set, continuity, and a closed target condition; geometric form obtained by inversion |

Book 167 is used only for the density and transport theorem whose consequence was proved explicitly in Lemma 5.2. No later-numbered deformation--Hecke, support, or patching theorem is used.
