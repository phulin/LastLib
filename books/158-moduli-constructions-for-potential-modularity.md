...
The compatible-family arithmetic source in
`../FLT/FLT/GaloisRepresentation/HardlyRamified/Family/Arithmetic.lean` subsequently asks for
potential modularity, Brauer induction, solvable base change, local--global compatibility, and
stable lattices.  The moduli construction supplies only the potential-modularity field and
the two-prime geometric object.  It does not supply the automorphic or lattice parts of that
source record.
...
after Corollary 6.1 are arithmetic.
...
inside the construction of the potential-automorphy field used to build the automorphic Brauer
data.  Original-prime Frobenius comparison, conductor control, and integral models at the other
coefficient primes remain separate fields of that source record.
