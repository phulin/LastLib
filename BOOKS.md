...
41. **Heights, Mordell--Weil, and the Faltings--Tate Reduction** — Construct Weil and
   ...
   prerequisites; (13.3r) separately records the unresolved determinant-slope/boundary estimate.
   Thus Tate semisimplicity remains conditional.
...
138. **Integral Local Types and Type Lattices** — Construct integral primary and companion lattices for principal, special, depth-zero dihedral, and tame positive-depth local types, together with their represented enhanced deformation conditions. Realize the Steinberg flag rows on the generic parahoric tower and identify their correct bad-fiber extension as a strict procyclic constructible complex, conditional at the remaining principal node-and-stabilizer inputs $({\rm HDB}_v)$ and $({\rm RGC}_v)$ of Book 122. Banality, ordering, sign, and saturation hypotheses are retained, and primitive wild or ramified dyadic positive-depth types are excluded.
...
157. **Local Geometry of Hilbert--Blumenthal Moduli** — Construct real, good, ordinary,
   ...
   simultaneous unit- and twist-invariant regular projective fan.  It does not construct the
   algebraic cusp embeddings for that fan or prove their gluing to the good interior.  Required
   Theorem 13.2B.3 isolates the remaining fan-dependent toroidal compactification theorem:
   construct the cusp modifications, identify their completed normalized charts and universal
   Mumford objects, prove proper smooth gluing, and descend the twist and an ample bundle.
...
168. **Compatible Coefficient Systems and Purity** — Import Book 127's curve-carried weak family,
   ...
   ramified Hodge-base-change, toroidal-compactification, metrized theta--Hodge, and determinant-slope interfaces. Raw
