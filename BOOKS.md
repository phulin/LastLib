...
176. **Nonminimal Modularity Lifting** — Import the conditional one-prime Ihara, type-complex,
   ...
   for the actual finite set; together with the clean minimal structural ledger it is
   $({\rm DMS}_{P_{\rm tar}})$. A finite-free paired countermodel shows why upper-side patching,
   residual monodromy zero, and saturated degeneracy maps do not imply DLO.
