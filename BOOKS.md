...
157. **Local Geometry of Hilbert--Blumenthal Moduli** — Construct real, good, ordinary,
   ...
   a singleton mixed moving presentation.  Section 13.2A isolates the exact stable integral
   connecting-slice assertion and proves its conditional handoff to Book 154, but records that
   compatibility of a finite-type projective model with the cusp germ and good interior, and
   the required stable relative slice on it, are absent.
