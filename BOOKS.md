...
results, so their proofs are not split into additional catalog volumes here. They remain genuine
prerequisites: no theorem supplied by either development is treated as an axiom.

The books are numbered 1–192 in one linear sequence. Where a broad book overlaps a specialist
monograph, the broad book is retained as a capstone treatment that unifies the subject. Topical
order is not dependency order; substantial prerequisites are recorded in `BOOK_DEPENDENCIES.md`.
...
10. **Normalization and Regular Models of Arithmetic Curves** — Prove the required finiteness
...
11. **Blowups and Intersection Theory on Arithmetic Surfaces** — Develop blowups, strict
...
12. **Semistable Curves, Dual Graphs, and Component Groups** — Study nodal and semistable
...
13. **Faithfully Flat Descent in Algebraic Geometry** — Prove effective fpqc descent for
...
14. **Moduli Stacks for Modular and PEL Problems** — Develop fibered categories, stacks,
...
16. **Arithmetic Spectral Sequences and Derived Cohomology** — Starting from the general
...
17. **Cotangent Complexes, Perfect Complexes, and Determinant Lines** — Treat cotangent
...
18. **Formal Schemes, GAGA, and Algebraization** — Develop adic formal schemes, completion,
...
19. **Finite Étale Covers and Fundamental Groups**
...
20. **Étale Sheaves and Cohomology on Curves**
...
21. **Derived Étale and ℓ-adic Cohomology** — Construct étale cohomology through derived global
...
22. **Proper and Smooth Base Change** — Prove constructibility, proper base change, smooth base
change, local acyclicity, and specialization for the relative curves, abelian schemes, and PEL
families in the FLT route.

23. **Étale Duality and Trace Maps in Low Dimension** — Construct compact support, trace maps,
...
24. **Nearby Cycles and Monodromy in Dimensions One and Two** — Develop nearby and vanishing
...
25. **Lefschetz Trace Formulas for Curves and Surfaces** — Construct Frobenius and compactly
...
26. **Weights, Hard Lefschetz, and Weil Bounds in Low Dimension** — Develop weights and purity
...
27. **Betti, de Rham, and Étale Comparison for Curves** — Construct singular (co)homology,
...
29. **Continuous Cohomology of Profinite Groups**
...
32. **Global Galois Cohomology and Selmer Groups**
...
34. **Rigid Analytic Curves and Formal Models** — Develop Tate algebras, affinoid localization,
...
35. **Rigid Uniformization of Abelian Varieties** — Develop analytic tori, discrete lattices,
...
36. **Relative Picard Schemes and Jacobians** — Construct Picard sheaves and schemes,
...
37. **Jacobians and (H^1) of Curves**
...
38. **Abelian Schemes, Isogenies, and Polarizations** — Develop dual abelian schemes, finite
...
39. **Néron Models and Component Groups** — Construct Néron models of Jacobians and the
...
44. **Finite Locally Free Schemes and Algebras**
...
45. **Affine Group Schemes and Hopf Algebras**
...
46. **Finite Flat Commutative Group Schemes**
...
48. **Finite-Flat Galois Representations**
...
50. **Tate Curves and Multiplicative Reduction**
...
51. **Torsion and Tate Modules of Elliptic Curves**
...
52. **Algebraic de Rham Cohomology and Gauss–Manin Connections** — Construct de Rham
cohomology of curves and abelian schemes, Hodge filtrations, cup products, base change, and
Gauss–Manin connections.

53. **Divided Powers and Crystalline Sites** — Develop PD rings and envelopes, crystalline
sites and topoi, crystals, Frobenius crystals, and the functorial constructions required in
degree one.

54. **Crystalline Cohomology of Curves and Abelian Schemes** — Construct derived crystalline
...
55. **Syntomic Cohomology and Integral Period Maps** — Construct the weight-zero and
...
56. **Finite-Flat Group Schemes of Small Height** — Develop schematic closure and exact
...
57. **Dieudonné Theory and Raynaud Full Faithfulness** — Construct Dieudonné modules in the
...
58. **Fontaine–Laffaille Modules and Torsion Representations** — Develop divided filtered
...
59. **Integral Fontaine–Laffaille Equivalence and Base Change** — Prove essential
...
60. **p-divisible Groups and Serre–Tate Theory** — Develop connected–étale decompositions,
ordinary deformation coordinates, canonical lifts, and openness of the ordinary local loci used
in potential modularity.

61. **Ramification and Discriminants of Finite-Flat Representations** — Prove the
...
62. **Artinian and Complete Local Coefficient Rings**
...
63. **Pseudocompact Trace Algebras and Carayol Descent** — Develop closed subalgebras of
...
64. **Deformation Functors of Representations**
...
65. **Representability of Deformation Problems**
...
66. **Local Deformation Conditions Away from (\ell)**
...
67. **Finite-Flat Deformation Conditions at (\ell)**
...
68. **Global Deformation Problems**
...
69. **Complete Local Algebra for Deformation Theory**
...
70. **Depth, Complete Intersections, and Fitting Ideals**
...
76. **Smooth Representations of (p)-adic Groups**
...
78. **Parabolic Induction, Jacquet Modules, and Whittaker Models for GL₂** — Treat principal
series, the geometric lemma in rank one, Jacquet modules, Whittaker uniqueness, Kirillov models,
and local zeta integrals.

79. **Dihedral Supercuspidals, Types, and Newvectors for GL₂** — Construct the tame and
...
80. **Weil–Deligne Representations and Local Constants** — Develop Weil and Weil–Deligne
...
81. **Local Langlands in the Principal, Special, and Dihedral Cases** — Construct and
...
82. **Representations of Quaternion Division Algebras**
...
83. **Characters and Dihedral Types on Quaternion Division Algebras** — Construct special
...
85. **Local Jacquet–Langlands for Special and Dihedral Packets** — Prove the character
...
86. **Cyclic Base Change: Local Theory**
...
87. **Quaternion Algebras over Number Fields**
...
88. **Orders in Quaternion Algebras**
...
89. **Automorphic Forms on Definite Quaternion Algebras**
...
90. **Hecke Operators on Quaternionic Forms**
...
91. **Hecke Algebras and Congruences**
...
92. **Automorphic Representations of (GL_2)**
...
93. **Automorphic Representations of (D^\times)**
...
95. **Hecke Characters and Automorphic Induction from (GL_1)**
...
96. **Cyclic Base Change for (GL_2)**
...
97. **Solvable Base Change and Descent**
...
98. **Schwartz–Bruhat Analysis and Tate’s Thesis** — Construct adelic Schwartz spaces,
...
99. **Archimedean GL₂ and Discrete Series** — Develop real reductive groups, Harish–Chandra
...
100. **Hilbert-Space Spectral and Trace-Class Theory** — Develop unbounded self-adjoint
...
101. **Sobolev Theory and Elliptic Regularity on Arithmetic Quotients** — Develop invariant
...
102. **Reduction Theory and the Cuspidal Spectrum of GL₂** — Prove adelic reduction theory,
...
103. **Global Constant Terms and Eisenstein Contributions for GL₂** — Develop parabolic
...
104. **Global Whittaker Models and Rankin–Selberg Theory** — Prove global genericity, Whittaker
...
105. **Analytic Theory of Automorphic Rankin–Selberg L-functions** — Prove continuation,
...
106. **Strong Multiplicity One and Global Newforms for GL₂** — Use Rankin–Selberg pole
...
107. **Algebraicity and Integral Structures of Weight-Two Packets** — Prove rationality fields,
...
108. **Cuspidal Trace-Formula Kernels for Rank Two** — Construct automorphic kernels with a
...
109. **The Cuspidal Spectral Side of the GL₂ Trace Formula** — Compute the discrete cuspidal
...
110. **The Geometric Side of the GL₂ Trace Formula** — Classify rational conjugacy classes,
...
111. **Orbital Integrals for GL₂ and Quaternion Algebras** — Compute the required
...
112. **Transfer of Test Functions and the Rank-Two Fundamental Lemma** — Construct matching
...
113. **Twisted Conjugacy and Geometric Trace Distributions** — Develop twisted conjugacy,
norms, centralizers, stable classes, measures, and the convergent geometric distributions for
prime-degree cyclic extensions.

114. **Twisted Cuspidal Trace Kernels and Spectral Expansion** — Construct twisted automorphic
...
115. **Twisted Orbital Matching and the Cyclic Fundamental Lemma** — Prove unramified norm
...
116. **Generalized Elliptic Curves and Level Structures** — Construct generalized elliptic
...
117. **Compactified Modular Stacks and Coarse Modular Curves** — Construct compactified stacks,
...
118. **Deligne–Rapoport Integral Models of Modular Curves** — Prove regularity and smoothness
...
119. **Integral Modular Forms and q-Expansion** — Develop Katz modular forms through the Hodge
...
121. **Modular Jacobians, Néron Models, and Hecke Correspondences** — Construct the integral
...
123. **Reductive Groups, Inner Forms, and Corestriction in Rank Two** — Develop root data,
...
124. **CM Abelian Varieties, Types, and Reflex Norms** — Develop CM fields, types and orders,
...
125. **Complex Multiplication, Reciprocity, and Reduction** — Prove the main complex-
...
128. **Uniformization, Components, and Hecke Descent for Shimura Curves** — Prove complex
...
132. **Automorphic Decomposition of Shimura-Curve H¹** — Relate constant-coefficient H¹ of the
...
136. **Local–Global Compatibility for Weight-Two Galois Representations** — Prove good-prime
...
137. **Compatible Coefficient Systems and Purity** — Construct strictly compatible systems from
...
138. **Canonical Galois Lattices and Finite-Flat Quotients** — Construct the canonical localized
...
142. **Eisenstein Series, Congruences, and the Eisenstein Ideal** — Construct the prime-level
...
143. **Cuspidal Divisors and Specialization on Modular Jacobians** — Determine the cuspidal
...
144. **Mazur–Raynaud Admissible Group Schemes** — Develop the category of group schemes finite
...
145. **Completed Hecke Pieces and Eisenstein p-divisible Groups** — Construct the selected
...
146. **Eisenstein Descent and the Mordell–Weil Group of the Eisenstein Quotient** — Develop
...
147. **Eisenstein Cotangent Lattices and Formal Immersion** — Develop integral cotangent
...
149. **Genus-Two Curves, Jacobians, and Abel–Jacobi Geometry** — Develop hyperelliptic curves of
...
150. **Mumford Representations and Exact Genus-Two Jacobian Arithmetic** — Develop unique
...
151. **Explicit Two-Descent on Genus-Two Jacobians** — Develop étale descent algebras, S-unit
...
152. **Mordell–Weil Sieves for Hyperelliptic Curves** — Develop reduction-set constraints,
...
153. **Semistable Isogeny Characters and Frey Residual Representations** — Analyze the diagonal
...
157. **Integral Local Types and Type Lattices** — Construct integral principal, Steinberg, and
...
158. **Ihara Theory and Saturated Degeneracy Maps on Shimura Curves** — Prove geometric Ihara
...
159. **Integral Level Change and Jacquet–Langlands Comparison** — Refine rational
...
160. **Deep-Level Quaternionic Modules and Diamond Actions** — Construct the Taylor–Wiles
level modules, prove group-ring freeness, primary and companion duality, exact augmentation, and
transition-map compatibility.

161. **Hecke-Valued Galois Representations and Nonminimal Reciprocity** — Construct
...
162. **Dickson Classification and Adequate Residual Image** — Classify finite subgroups of
...
163. **The Minimal Totally-Real Deformation–Hecke Problem** — Match local and global deformation
...
164. **Minimal Patching and R=T over Totally Real Fields** — Construct the Taylor–Wiles
...
165. **One-Prime Type Complexes and Component Support** — Develop the fixed-prime degeneracy
...
166. **One-Prime Nonminimal Patching and R=T** — Combine Book 165 with the minimal theorem,
...
171. **Galois and Solvable Refinements of Arithmetic Approximation** — Control normal closures,
...
172. **Hilbert–Blumenthal Moduli and Two-Prime Level Covers** — Construct fine polarized
...
173. **Local Geometry of Hilbert–Blumenthal Moduli** — Construct real, good, ordinary,
...
174. **Auxiliary Dihedral Data and Residual Potential Modularity** — Carry out the two-prime
...
181. **Schoof's Finite-Flat Category over ℤ[1/2]** — Construct the category of finite-flat
...
182. **Local Conditions for Hardly-Ramified Minimal Deformations** — Study the
...
183. **Supported Galois Cohomology and Selmer Calculations** — Develop finite local cohomology,
...
184. **Relation Obstructions and Poitou–Tate Corrections** — Develop relation factor sets and
...
185. **Finite Image and the Balanced Minimal-Lift Argument** — Prove finite image after scalar
...
186. **Potential Automorphy and Galois Refinement of a Chosen Lift** — Apply the two-prime
...
187. **Brauer Induction for Automorphy Families** — Develop the finite-group Brauer relations
...
188. **Brauer Characters and Effectivity of Compatible Families** — Develop Mackey theory,
...
189. **Compatible Systems over the Base Field** — Combine the systems over elementary
...
190. **The Fixed-Three Integral Local Theory** — Starting from the effective three-adic member,
...
191. **Quintic Cyclotomic Units and Kummer Arithmetic** — Work in Q(ζ₅), taking the
...
192. **Cyclotomic Descent for Quintic Fermat-Type Equations** — Develop first- and second-case
