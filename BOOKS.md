...
168. **Compatible Coefficient Systems and Purity** — Import Book 127's curve-carried weak family,
   ...
   monodromy operator, line, and sign. The missing input is smooth-proper Hodge--Tate comparison
   plus the one-dimensional Hodge--Tate-to-locally-algebraic theorem; no Faltings-height or
   ambient Tate-semisimplicity theorem is needed. Record ambient curve-$H^1$ semisimplicity as a
