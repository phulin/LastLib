...
- **066 -- Representability of Deformation Problems: PENDING.** No full-read-to-EOF attestation yet.
- **067 -- Local Deformation Conditions Away from ell: PENDING.** No full-read-to-EOF attestation yet. A malformed summary table was repaired in commit `65b29c6`; final verdict awaits the fresh full read.
- **068 -- Finite-Flat Deformation Conditions at ell: PENDING.** No full-read-to-EOF attestation yet.
