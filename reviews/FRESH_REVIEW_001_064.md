...
### X004 — Book 008 uses inseparable normalization finiteness before the Japanese/excellence theorem

- **Consumer:** Book 008, §9.1, especially the finite-normalization lemma at repaired lines 1208–1223 and the projectivity argument at lines 1225–1239; later Books 009, 011, 015, and 017a consume Book 008's projective-curve and divisor parameter-space package.
...
- **Recommended chronological repair:** either prove the special theorem that $k[t]$ is Japanese, with a complete inseparable argument, before the finite-normalization lemma in Book 008, or move the smooth-proper-curve projectivity proof and every conclusion depending on this normalization construction to after Book 010a's universally Japanese theorem. Do not cite general excellence from Book 008 in its present chronological position.
